...
public class YearlyService {
	...
	public String getCleanDisInfect() {
		return cleanDisInfect;
	}
	public void setCleanDisInfect(String cleanDisInfect) {
		this.cleanDisInfect = cleanDisInfect;
	}
